...
class NCBIDatasetsServer {
        ...
        this.server.setRequestHandler(ReadResourceRequestSchema, async (request) => {
            ...
            if (genomeMatch) {
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InternalError, `Failed to fetch genome ${accession}: ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
            ...
            if (taxonomyMatch) {
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InternalError, `Failed to fetch taxonomy ${taxId}: ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
            ...
            if (assemblyMatch) {
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InternalError, `Failed to fetch assembly ${assemblyAccession}: ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
            ...
            if (searchMatch) {
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InternalError, `Failed to search ${dataType} for ${query}: ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
    ...
    async handleSearchGenomes(args) {
        ...
        try {
            ...
            if (args.assembly_level)
                params.assembly_level = args.assembly_level;
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search genomes: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetGenomeInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get genome info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetGenomeSummary(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get genome summary: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchGenes(args) {
        ...
        try {
            ...
            if (args.gene_symbol)
                params.symbol = args.gene_symbol;
            if (args.gene_id)
                params.gene_id = args.gene_id.toString();
            if (args.organism)
                params.taxon = args.organism;
            if (args.tax_id)
                params.taxon = args.tax_id.toString();
            if (args.chromosome)
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search genes: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetGeneInfo(args) {
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get gene info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetGeneSequences(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get gene sequences: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchTaxonomy(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search taxonomy: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetTaxonomyInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get taxonomy info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetOrganismInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get organism info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchAssemblies(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search assemblies: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetAssemblyInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get assembly info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetAssemblyReports(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get assembly reports: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleDownloadGenomeData(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get download info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleBatchAssemblyInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get batch assembly info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    ...
    async handleSearchVirusGenomes(args) {
        try {
            ...
            if (args.virus_name)
                params.q = args.virus_name;
            if (args.tax_id)
                params.taxon = args.tax_id.toString();
            if (args.host)
                params.host = args.host;
            if (args.collection_date_start)
                params.collection_date_start = args.collection_date_start;
            if (args.collection_date_end)
                params.collection_date_end = args.collection_date_end;
            if (args.geo_location)
                params.geo_location = args.geo_location;
            if (args.page_token)
                params.page_token = args.page_token;
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search virus genomes: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetVirusInfo(args) {
        ...
        try {
            const params = {};
            if (args.include_proteins !== false)
                params.include_proteins = true;
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get virus info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchProteins(args) {
        try {
            ...
            if (args.protein_name)
                params.q = args.protein_name;
            if (args.organism)
                params.organism = args.organism;
            if (args.tax_id)
                params.taxon = args.tax_id.toString();
            if (args.gene_symbol)
                params.gene_symbol = args.gene_symbol;
            if (args.function_keywords)
                params.function = args.function_keywords;
            if (args.page_token)
                params.page_token = args.page_token;
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search proteins: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetProteinInfo(args) {
        ...
        try {
            const params = {};
            if (args.include_sequence !== false)
                params.include_sequence = true;
            if (args.include_domains !== false)
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get protein info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetGenomeAnnotation(args) {
        ...
        try {
            ...
            if (args.start_position)
                params.start = args.start_position;
            if (args.end_position)
                params.end = args.end_position;
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get genome annotation: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchGenomeFeatures(args) {
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search genome features: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleCompareGenomes(args) {
        ...
        try {
            ...
            if (args.include_orthologs)
                params.include_orthologs = true;
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to compare genomes: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleFindOrthologs(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to find orthologs: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetSequenceData(args) {
        if (!args.accession || typeof args.accession !== 'string') {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get sequence data: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleBlastSearch(args) {
        ...
        try {
            ...
            if (args.organism_filter)
                params.organism = args.organism_filter;
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to perform BLAST search: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetPhylogeneticTree(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get phylogenetic tree: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetTaxonomicLineage(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get taxonomic lineage: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetDatabaseStats(args) {
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get database stats: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchByBioproject(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search by BioProject: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchByBiosample(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search by BioSample: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetAssemblyQuality(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get assembly quality: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleValidateSequences(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to validate sequences: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async run() {
