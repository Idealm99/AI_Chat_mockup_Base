...
const isValidPathwayInfoArgs = (args) => {
    return (typeof args === 'object' &&
        args !== null &&
...
const isValidBatchArgs = (args) => {
    return (typeof args === 'object' &&
        ...
        args.entry_ids.every((id) => typeof id === 'string' && id.length > 0) &&
        (args.operation === undefined || ['info', 'sequence', 'pathway', 'link'].includes(args.operation)));
};
const isValidBriteSearchArgs = (args) => {
    return (typeof args === 'object' &&
        args !== null &&
        typeof args.query === 'string' &&
        args.query.length > 0 &&
...
class KEGGServer {
        ...
        this.server.setRequestHandler(ReadResourceRequestSchema, async (request) => {
            ...
            if (compoundMatch) {
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InternalError, `Failed to fetch compound ${compoundId}: ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
            ...
            if (searchMatch) {
                ...
                try {
                    ...
                    throw new McpError(ErrorCode.InternalError, `Failed to search ${database} for ${query}: ${error instanceof Error ? error.message : 'Unknown error'}`);
                }
            }
    ...
    async handleGetDatabaseInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get database info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleListOrganisms(args) {
        ...
        try {
            ...
            const limitedOrganisms = Object.fromEntries(Object.entries(organisms).slice(0, limit));
            return {
                content: [
                    {
                        type: 'text',
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to list organisms: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchPathways(args) {
        ...
        try {
            ...
            const limitedResults = Object.fromEntries(Object.entries(results).slice(0, maxResults));
            return {
                content: [
                    {
                        type: 'text',
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search pathways: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetPathwayInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get pathway info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetPathwayGenes(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get pathway genes: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    ...
    async handleConvertIdentifiers(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to convert identifiers: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleFindRelatedEntries(args) {
        if (!args.source_db || !args.target_db) {
            throw new McpError(ErrorCode.InvalidParams, 'Source and target databases are required');
        }
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to find related entries: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    // Additional handler implementations
    async handleSearchReactions(args) {
        if (!isValidSearchArgs(args)) {
            throw new McpError(ErrorCode.InvalidParams, 'Invalid search arguments');
        }
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search reactions: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetReactionInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get reaction info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchEnzymes(args) {
        if (!isValidSearchArgs(args)) {
            throw new McpError(ErrorCode.InvalidParams, 'Invalid search arguments');
        }
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search enzymes: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetEnzymeInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get enzyme info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchDiseases(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search diseases: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetDiseaseInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get disease info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    ...
    async handleGetDrugInteractions(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get drug interactions: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchModules(args) {
        if (!isValidSearchArgs(args)) {
            throw new McpError(ErrorCode.InvalidParams, 'Invalid search arguments');
        }
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search modules: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetModuleInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get module info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchKoEntries(args) {
        if (!isValidSearchArgs(args)) {
            throw new McpError(ErrorCode.InvalidParams, 'Invalid search arguments');
        }
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search KO entries: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetKoInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get KO info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchGlycans(args) {
        if (!isValidSearchArgs(args)) {
            throw new McpError(ErrorCode.InvalidParams, 'Invalid search arguments');
        }
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search glycans: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetGlycanInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get glycan info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleSearchBrite(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to search BRITE: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetBriteInfo(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get BRITE info: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetPathwayCompounds(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get pathway compounds: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetPathwayReactions(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get pathway reactions: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetCompoundReactions(args) {
        if (!args.compound_id || typeof args.compound_id !== 'string') {
            throw new McpError(ErrorCode.InvalidParams, 'Compound ID is required');
        }
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get compound reactions: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleGetGeneOrthologs(args) {
        ...
        try {
            ...
            throw new McpError(ErrorCode.InternalError, `Failed to get gene orthologs: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleBatchEntryLookup(args) {
