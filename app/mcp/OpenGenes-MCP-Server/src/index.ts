          ...
          case 'get_gene_by_id':
            ...
            return {
              content: [
                {
                  type: 'text',
                  text: JSON.stringify(await geneTools.getGeneById(args as any), null, 2),
                },
              ],
            };
          case 'get_gene_by_symbol':
            ...
            return {
              content: [
                {
                  type: 'text',
                  text: JSON.stringify(await geneTools.getGeneBySymbol(args as any), null, 2),
                },
              ],
            };
          case 'get_gene_by_ncbi_id':
            ...
            return {
              content: [
                {
                  type: 'text',
                  text: JSON.stringify(await geneTools.getGeneByNcbiId(args as any), null, 2),
                },
              ],
            };
          ...
          case 'get_genes_by_functional_cluster':
            ...
            return {
              content: [
                {
                  type: 'text',
                  text: JSON.stringify(await geneTools.getGenesByFunctionalCluster(args as any), null, 2),
                },
              ],
            };
          case 'get_genes_by_selection_criteria':
            ...
            return {
              content: [
                {
                  type: 'text',
                  text: JSON.stringify(await geneTools.getGenesBySelectionCriteria(args as any), null, 2),
                },
              ],
            };
          case 'get_genes_by_go_term':
            ...
            return {
              content: [
                {
                  type: 'text',
                  text: JSON.stringify(await geneTools.getGenesByGoTerm(args as any), null, 2),
                },
              ],
            };
          case 'get_genes_by_expression_change':
            ...
            return {
              content: [
                {
                  type: 'text',
                  text: JSON.stringify(await geneTools.getGenesByExpressionChange(args as any), null, 2),
                },
              ],
            };
          case 'get_gene_taxon':
